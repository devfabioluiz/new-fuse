...
const generatePalette = require(path.resolve(__dirname, ('src/app/tailwind/utils/generate-palette')));
...
const config = {
  ...
  plugins     : [
      ...
      require(path.resolve(__dirname, ('src/app/tailwind/plugins/extract-config'))),
      ...
      require(path.resolve(__dirname, ('src/app/tailwind/plugins/theming')))({themes}),
